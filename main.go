...
func executeTemplate(w http.ResponseWriter, filepath string) {
	...
	if err != nil {
		...
		http.Error(w, "There was an error parsing this template.", http.StatusInternalServerError)
		return
	}
	err = tpl.Execute(w, nil)
	if err != nil {
		log.Printf("executing template: %v", err)
		http.Error(w, "There was an error executing this template.", http.StatusInternalServerError)
		return
	}
}
